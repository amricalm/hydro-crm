...
class EmployeController extends Controller
{
    ...
    public function index(Request $req)
    {
        ...
        return view('pages.employe.index', $app);
    }

    public function get(Request $req)
    {
        $data = Employe::where('id',$req->id)->get()->toArray();
    ...
    {
        try {
            Employe::where('id',$req->id)->delete();
            $response= Adn::Response(true,"Sukses");
        }
        catch(\PDOException $e)
        {
    ...
    public function getTabel(Request $req){
        ...
        ->offset($limit_start)
        ->limit($limit)->get();
        $jmh = Employe::where('status',$status);
