    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu" style="display: none;">
                ...
                <li><a href="{{ url('jenis-produk') }}" class="slide-item">Jenis Produk</a></li>
        ...
        @endif
        <li class="slide">
            <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('aktivitas/create') }}">
            ...
            <span class="side-menu__label">Aktivitas</span></a>
        </li>
    </ul>
</aside>
<!--aside closed-->
