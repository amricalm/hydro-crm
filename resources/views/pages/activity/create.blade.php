                        ...
                        <div class="card mb-4">
                            <div class="card-body py-4">
                                <div class="form-group row row-sm mb-0">
                                    ...
                                    <div class="col-md-3">
                                        <input type="date" id="tx-name" name="name" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                    </div>
                                </div>
                                <div class="form-group row row-sm mb-0">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Tanggalx</label>
                                                                <div class="col-md-9">
                                                                    <input type="date" id="tx-name" name="name" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea type="text" id="tx-hp" name="hp" rows="4" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row row-sm mb-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea type="text" id="tx-hp" name="hp" rows="2" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
