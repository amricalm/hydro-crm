                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="date" id="tx-date" name="date" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group row row-sm mb-0">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input type="text" name="email" id="tx-email" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Facebook</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" name="fb_link" id="fb_link" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Instagram</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" name="ig_link" id="ig_link" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea type="text" name="address" id="address" rows="4" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Provinsi</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" name="province" id="province" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Kota</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" name="city" id="city"  autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Kode Pos</label>
                                                                <div class="col-md-9">
                                                                    <input type="text" name="post_code" id="post_code" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <select name="action_id" id="action_id" class="form-select form-control  form-control-sm  mb-2" tabindex="10">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Keterangan Aksi</label>
                                                                <div class="col-md-9">
                                                                    <textarea type="text" id="action_desc" name="action_desc" rows="2" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Respon</label>
                                                                <div class="col-md-9">
                                                                    <select name="response_id" id="response_id" class="form-select form-control  form-control-sm  mb-2" tabindex="10">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group row row-sm mb-0">
                                                                <label class="col-md-3 form-label">Keterangan Respon</label>
                                                                <div class="col-md-9">
                                                                    <textarea type="text" id="response_desc" name="response_desc" rows="2" autocomplete="off" class="form-control  form-control-sm  mb-2" tabindex="13"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
